...
const L: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    heroBody: 'هذه استمارة الوالد من مقياس NICHQ Vanderbilt — المستخدمة عالمياً لفرز فرط الحركة وتشتت الانتباه لدى الأطفال (6–12 سنة). تجيب عن سلوك طفلك خلال الأشهر الستة الماضية.',
    disclaimerLabel: 'مهم:',
