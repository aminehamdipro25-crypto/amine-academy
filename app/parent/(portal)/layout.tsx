...
export default function ParentPortalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#FFF8F0' }}>
      ...
      {/* ── Desktop sidebar ── */}
      <aside
        className="hidden md:flex fixed right-0 top-0 bottom-0 w-56 flex-col z-40"
        style={{ background: '#FFFFFF', borderLeft: '1.5px solid #F0E8FF', boxShadow: '-4px 0 20px rgba(124,92,252,0.04)' }}
      >
        {/* Logo */}
        <div className="p-5" style={{ borderBottom: '1.5px solid #F0E8FF' }}>
      ...
      {/* ── Main content ── */}
      <main className="md:mr-56 pb-20 md:pb-6">
