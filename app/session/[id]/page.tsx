...
const VIDEO_LIBRARY: Record<string, { desc: string; tips: string[]; videoId?: string }> = {
  ...
  'calm-corner':         { videoId: 'lAgnqQ3sbwk', desc: 'مساحة آمنة يلجأ إليها الطفل عند الإرهاق لتنظيم نفسه ذاتياً.', tips: ['بيئة هادئة وخافتة الإضاءة', 'أدوات حسية: كرة ضغط، سماعات', 'لا يُستخدم كعقاب', 'علّم الطفل متى يذهب إليه'] },
  'jumping-jacks':       { videoId: 'mePc87XdsIE', desc: 'ينشّط الجسم ويفرغ الطاقة الزائدة ويُحسّن التنسيق الثنائي.', tips: ['3 مجموعات × 10 قفزات', 'استخدمه قبل جلسات التركيز', 'تأكد من تزامن الذراعين والساقين', 'زد الوتيرة تدريجياً'] },
  ...
  'balance-walk':        { videoId: 'KwjBGh7khco', desc: 'يُنشّط المخيخ المسؤول عن الانتباه ويُحسّن التنسيق بين الجانبين.', tips: ['ضع شريطاً لاصقاً على الأرض', 'امشِ ببطء مركّزاً على التوازن', 'جرّب بأعين مغمضة لاحقاً', 'احمل غرضاً على رأسك لزيادة الصعوبة'] },
  'tiger-crawl':         { videoId: 'SBNxJuEXDyc', desc: 'يُنشّط التكامل بين نصفي المخ وهو أساسي للقراءة والانتباه.', tips: ['اليد اليمنى مع الركبة اليسرى في آنٍ', 'الزحف ببطء مع الوعي الكامل', '5-7 دقائق قبل التمارين المعرفية', 'مناسب لجميع الأعمار'] },
  'body-percussion':     { videoId: 'MC4rQKU9cEk', desc: 'يُحسّن التنسيق الدقيق والإيقاع الزمني والانتباه المستمر.', tips: ['ابدأ بنمط بسيط: تصفيق + ضرب الركبة', 'كرر 3 مرات قبل أن يؤديه وحده', 'زد التعقيد تدريجياً', 'استخدم موسيقى هادئة'] },
  'body-scan':           { videoId: 'JL_22TU80Hs', desc: 'يُطوّر الوعي الجسدي ويُساعد على رصد التوتر قبل الانفجار الانفعالي.', tips: ['الطفل مستلقٍ أو جالس بهدوء', 'انتقل من القدمين للرأس', 'اطلب منه توصيف ما يشعر به', '10 دقائق كافية للتأثير'] },
  'emotion-cards':       { videoId: 'wPITpAMRHHU', desc: 'يُطوّر الذكاء الانفعالي والقدرة على قراءة تعابير الوجه.', tips: ['استخدم صوراً حقيقية لأشخاص', 'اربط المشاعر بمواقف يومية', 'اطلب منه تمثيل المشعر بجسده', 'ابدأ بالمشاعر الأساسية الستة'] },
  'emotion-mirror':      { videoId: 'PDjIzdLXK80', desc: 'يُطوّر التواصل الاجتماعي من خلال تقليد تعابير الوجه.', tips: ['قفا أمام مرآة معاً', 'ابدأ بمشاعر واضحة: فرح، حزن', 'تناوبا الأدوار', 'اربط كل تعبير بحدث يومي'] },
  'social-scenarios':    { videoId: 'ANwBmsfywkA', desc: 'يُطوّر التعامل مع المواقف الاجتماعية وحل النزاعات بشكل بناء.', tips: ['استخدم مواقف من حياة الطفل الفعلية', 'اسأل: ماذا تفعل؟ وماذا سيحدث؟', 'ناقش أكثر من حل ممكن', 'العب أدواراً تمثيلية'] },
  ...
  'behavior-contract':   { videoId: 'dZd5X2MpxhQ', desc: 'يُوضّح التوقعات والمكافآت ويعزز التزام الطفل بأهدافه.', tips: ['اكتب الاتفاق معه لا له', 'هدف واحد فقط في البداية', 'مكافأة محددة وقابلة للتحقيق', 'راجعه أسبوعياً'] },
  'traffic-light':       { videoId: '0AFRnZEkqq4', desc: 'يُعلّم التوقف والتفكير قبل التصرف — أداة فعّالة لكبح الاندفاعية.', tips: ['أحمر: توقف وتنفس', 'أصفر: فكر في خياراتك', 'أخضر: تصرف', 'طبّق على مواقف يومية حقيقية'] },
  'stop-signal':         { videoId: 'hSsGS8Sec_0', desc: 'يُطوّر القدرة على كبح الاستجابة الاندفاعية وهو الأكثر فاعلية مع ADHD.', tips: ['ابدأ بزمن استجابة طويل ثم قلّصه', 'راقب دقة التوقف لا السرعة فقط', '10-15 دقيقة للجلسة', 'سجّل التحسن عبر الجلسات'] },
  'mood-meter':          { videoId: 'frN2YcB63NA', desc: 'يُطوّر الوعي الانفعالي ويُساعد الطفل على تسمية مشاعره وشدتها.', tips: ['محور أفقي: الطاقة (عالية/منخفضة)', 'محور رأسي: الشعور (إيجابي/سلبي)', 'ابدأ الجلسة بتحديد المزاج', 'استخدم الألوان للمساعدة'] },
  ...
  'finger-gym':          { videoId: 'mEalRQjsGqA', desc: 'يُطوّر الحركة الدقيقة ويُقوّي عضلات الأصابع للكتابة.', tips: ['فرد الأصابع واحداً تلو الآخر', 'ضرب كل أصبع بالإبهام', 'عجن الطين أو كرات الضغط', '5 دقائق قبل جلسات الكتابة'] },
  'memory-cards':        { videoId: 'LdxAMNLZpFU', desc: 'يُطوّر الذاكرة البصرية قصيرة المدى والانتباه الانتقائي.', tips: ['ابدأ بـ 6 بطاقات (3 أزواج)', 'زد تدريجياً حتى 20 بطاقة', 'شجعه على تسمية الصور بصوت عالٍ', 'راقب زمن الإنجاز'] },
  'sequence-memory':     { videoId: 'D3oRmGx7MVM', desc: 'يُطوّر الذاكرة العاملة وترتيب المعلومات في الزمن.', tips: ['ابدأ بتسلسل من 3 عناصر', 'استخدم أرقاماً ثم ألواناً ثم صوراً', 'سرعة التقديم: 1 ثانية/عنصر', 'أضف عنصراً كل 2-3 جلسات'] },
  'conversation-starter':{ videoId: 'ejjM1Apj56c', desc: 'يُعلّم الطفل كيف يبدأ محادثة ويُبقيها مستمرة.', tips: ['ابدأ بسؤال عن الطرف الآخر', 'تناوبا البدء والاستمرار', 'استخدم موضوعات مشتركة', 'راقب لغة الجسد'] },
  'choice-board':        { videoId: 'gIDaj-5wFwU', desc: 'يمنح الطفل شعوراً بالسيطرة مما يُقلّل مقاومة التعليمات.', tips: ['2-3 خيارات كافية', 'تأكد أن كل الخيارات مقبولة', 'الطفل يختار ويلتزم باختياره', 'استخدم صوراً للأطفال الصغار'] },
  'daily-goals':         { videoId: '8ttJ37GsF8Q', desc: 'يُطوّر التخطيط والتنظيم الذاتي ويُحسّن الشعور بالكفاءة.', tips: ['هدفان كحد أقصى', 'الأهداف قابلة للقياس والتحقيق', 'راجع الأهداف نهاية الجلسة', 'احتفل بالإنجاز مهما كان صغيراً'] },
  'ball-throw':          { videoId: 'Xc3DQ7XuSWY', desc: 'يُحسّن التنسيق البصري الحركي والتتبع البصري وسرعة رد الفعل.', tips: ['ابدأ بمسافة قريبة', 'تناوبا الرمي والإمساك', 'عدّ الرميات الناجحة', 'أضف مسافة تدريجياً'] },
  'emotion-volume':      { videoId: 'ejjM1Apj56c', desc: 'يُطوّر القدرة على تقدير شدة الانفعالات والتحكم في ردود الفعل.', tips: ['مقياس 1-10 أو صور صوتية', 'اربط الرقم بموقف حقيقي', 'ناقش متى يكون رقم 8 مناسباً', 'علّمه استراتيجيات خفض الرقم'] },
}
