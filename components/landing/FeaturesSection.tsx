...
const PILLARS = [
  {
    ...
    stat: '٤',
    statLabel: 'تمارين أساسية في المحور',
  ...
  },
  {
    ...
    desc: 'تمارين الوظيفة التنفيذية تبني الذاكرة العاملة، تكبح الاندفاعية، وتطوّر التخطيط، وفق مبادئ التدريب المعرفي.',
    descEn: 'Executive function exercises build working memory, inhibit impulsivity, and develop planning skills, following cognitive-training principles.',
    descFr: "Les exercices de fonction exécutive développent la mémoire de travail et freinent l'impulsivité, selon les principes de l'entraînement cognitif.",
    ...
    stat: '٤',
    statLabel: 'تمارين أساسية في المحور',
    statLabelEn: 'core exercises in this track',
    statLabelFr: 'exercices clés dans cet axe',
  },
]
