const steps = [
  ...
  },
  {
    ...
    desc: 'البروفيسور أمين يراجع الملف ويصمم برنامجاً فردياً يتضمن جدولاً أسبوعياً من التمارين والتدخلات النفسية.',
    icon: '🎨',
  ...
  },
  {
    ...
    desc: 'ولي الأمر يتابع لوحة تحكم متكاملة تعرض التقدم، التقارير الدورية، وملاحظات البروفيسور.',
    icon: '📊',
  ...
  },
  {
    ...
    desc: 'مواعيد فردية دورية مع البروفيسور أمين لمراجعة التقدم وتعديل البرنامج حسب استجابة الطفل.',
    icon: '🤝',
