...
const PROGRAMS = [
  {
    ...
    diagnosis: 'ADHD • Autism • ADHD+Autism • عسر القراءة',
  ...
  },
  {
    ...
    cbt: ['تدريب الذاكرة العاملة', 'برج المهام التنفيذية', 'تحدي التسلسل المعكوس', 'اليقظة الذهنية الحركية'],
    cbtEn: ['Working memory training', 'Executive Task Tower', 'Reverse sequence challenge', 'Movement-based mindfulness'],
    cbtFr: ['Mémoire de travail', 'Tour des tâches exécutives', 'Défi de séquence inversée', 'Pleine conscience par le mouvement'],
    ...
    diagnosis: 'ADHD • Autism • ADHD+Autism • صعوبات التعلم',
  ...
  },
  {
    ...
    diagnosis: 'ADHD • Autism • ADHD+Autism • صعوبات التنظيم',
