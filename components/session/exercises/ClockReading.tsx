...
export const QUARTER_QS: CQ[] = [
  { h:3,  m:15, label:'الثالثة والربع',        choices:['الثالثة والربع','الثالثة والنصف','الثالثة إلا ربع','الرابعة والربع'] },
  { h:5,  m:45, label:'السادسة إلا ربع',       choices:['السادسة إلا ربع','السادسة والربع','السادسة والنصف','السابعة إلا ربع'] },
  { h:9,  m:15, label:'التاسعة والربع',         choices:['التاسعة والربع','التاسعة والنصف','التاسعة إلا ربع','العاشرة والربع'] },
  { h:1,  m:45, label:'الثانية إلا ربع',        choices:['الثانية إلا ربع','الثانية والربع','الثالثة إلا ربع','الواحدة إلا ربع'] },
  ...
  { h:1,  m:50, label:'الواحدة وخمسون دقيقة', choices:['الواحدة وخمسون دقيقة','الواحدة والربع','الواحدة وعشر دقائق','الواحدة وأربعون دقيقة'] },
]
