...
export function appointmentReminderEmail(
  ...
  return wrap('#7C5CFC', `
    ...
    <div style="background:#FFFBEB;border-left:3px solid #F59E0B;border-radius:4px;padding:12px 16px">
...
export function newMessageAdminEmail(senderName: string, preview: string): string {
  return wrap('#7C5CFC', `
    ...
    <div style="background:#F3EEFF;border-left:3px solid #7C5CFC;border-radius:4px;padding:16px;margin:16px 0">
...
export function newMessageParentEmail(specialistName: string, preview: string): string {
  return wrap('#5b6ef2', `
    ...
    <div style="background:#f0f4ff;border-left:3px solid #5b6ef2;border-radius:4px;padding:16px;margin:16px 0">
      <p style="margin:0;color:#374151;line-height:1.8;white-space:pre-wrap">${escHtml(preview)}</p>
    </div>
    <div style="text-align:center;margin:24px 0">
